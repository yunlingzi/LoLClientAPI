...
DECLARE_INTERFACE_(ID3DXBaseMesh, IUnknown)
{
    ...
    STDMETHOD(CloneMeshFVF)(THIS_ DWORD Options,
                DWORD FVF, IDirect3DDevice9 * pD3DDevice, LPD3DXMESH* ppCloneMesh) PURE;
    STDMETHOD(CloneMesh)(THIS_ DWORD Options,
                CONST D3DVERTEXELEMENT9 *pDeclaration, IDirect3DDevice9 * pD3DDevice, LPD3DXMESH* ppCloneMesh) PURE;
...
DECLARE_INTERFACE_(ID3DXPMesh, ID3DXBaseMesh)
{
    ...
    STDMETHOD(ClonePMeshFVF)(THIS_ DWORD Options,
                DWORD FVF, IDirect3DDevice9 * pD3DDevice, LPD3DXPMESH* ppCloneMesh) PURE;
    STDMETHOD(ClonePMesh)(THIS_ DWORD Options,
                CONST D3DVERTEXELEMENT9 *pDeclaration, IDirect3DDevice9 * pD3DDevice, LPD3DXPMESH* ppCloneMesh) PURE;
...
DECLARE_INTERFACE_(ID3DXSPMesh, IUnknown)
{
    ...
    STDMETHOD(GetDevice)(THIS_ IDirect3DDevice9 ** ppDevice) PURE;
    STDMETHOD(CloneMeshFVF)(THIS_ DWORD Options,
                DWORD FVF, IDirect3DDevice9 * pD3DDevice, DWORD *pAdjacencyOut, DWORD *pVertexRemapOut, LPD3DXMESH* ppCloneMesh) PURE;
    STDMETHOD(CloneMesh)(THIS_ DWORD Options,
                CONST D3DVERTEXELEMENT9 *pDeclaration, IDirect3DDevice9 * pD3DDevice, DWORD *pAdjacencyOut, DWORD *pVertexRemapOut, LPD3DXMESH* ppCloneMesh) PURE;
    STDMETHOD(ClonePMeshFVF)(THIS_ DWORD Options,
                DWORD FVF, IDirect3DDevice9 * pD3DDevice, DWORD *pVertexRemapOut, FLOAT *pErrorsByFace, LPD3DXPMESH* ppCloneMesh) PURE;
    STDMETHOD(ClonePMesh)(THIS_ DWORD Options,
                CONST D3DVERTEXELEMENT9 *pDeclaration, IDirect3DDevice9 * pD3DDevice, DWORD *pVertexRemapOut, FLOAT *pErrorsbyFace, LPD3DXPMESH* ppCloneMesh) PURE;
...
DECLARE_INTERFACE_(ID3DXPRTEngine, IUnknown)
{
    ...
    STDMETHOD(GetAdaptedMesh)(THIS_ IDirect3DDevice9 * pD3DDevice,UINT *pFaceRemap, UINT *pVertRemap, FLOAT *pfVertWeights, LPD3DXMESH *ppMesh) PURE;
    ...
    STDMETHOD(ComputeDirectLightingSHGPU)(THIS_ IDirect3DDevice9 * pD3DDevice,
                                          UINT Flags,
                                          UINT SHOrder,
                                          FLOAT ZBias,
                                          FLOAT ZAngleBias,
